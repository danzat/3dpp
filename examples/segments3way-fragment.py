...
scene.line(A_B, B, style='very thick, DarkOrchid!50!black')
scene.line(C_D, D, style='very thick, OliveGreen!50!black')
scene.line(E_F, F, style='very thick, NavyBlue!50!black')

scene.line(A, A_B, style='very thick, DarkOrchid!50!white')
scene.line(C, C_D, style='very thick, OliveGreen!50!white')
scene.line(E, E_F, style='very thick, NavyBlue!50!white')
